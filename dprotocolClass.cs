    public class ConsoleJoinGameMessage : GameMessage
    {
        ...
        public string Field1 { get { return _Field1; } set { if(value != null && value.Length > 49) throw new ArgumentOutOfRangeException(); _Field1 = value; } }

        public override void Parse(GameBitBuffer buffer)
        {
            Field0 = buffer.ReadCharArray(128);
            Field1 = buffer.ReadCharArray(49);
        }

        public override void Encode(GameBitBuffer buffer)
        {
            buffer.WriteCharArray(128, Field0);
            buffer.WriteCharArray(49, Field1);
        }
    ...
    public class PlayEffectMessage : GameMessage
    {
        public int Field0;
        int _Field1;
        public int Field1 { get { return _Field1; } set { if(value < -1 || value > 71) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
        public int? Field2;
        ...
        public void EncodeValue(GameBitBuffer buffer)
{
    ...
    {
        public int snoObserver;

        public override void Parse(GameBitBuffer buffer)
        {
            snoObserver = buffer.ReadInt(32);
        }

        public override void Encode(GameBitBuffer buffer)
        {
            buffer.WriteInt(32, snoObserver);
        }

    }

    public class DifficultyAndHandicapMessage : GameMessage
    {
        public int Field0;
        public int Field1;
    ...
    public class DebugActorTooltipMessage : GameMessage
    {
        public int Field0;
        public string _Field1;
        public string Field1 { get { return _Field1; } set { if(value != null && value.Length > 1024) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
    ...
    {
        int _Field0;
        public int Field0 { get { return _Field0; } set { if(value < 0 || value > 4) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
        int[] _Field1;
    ...
    public class PetMessage : GameMessage
    {
        ...
        public int Field0 { get { return _Field0; } set { if(value < 0 || value > 7) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
        int _Field1;
        public int Field1 { get { return _Field1; } set { if(value < 0 || value > 63) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
        public int Field2;
        int _Field3;
        public int Field3 { get { return _Field3; } set { if(value < -1 || value > 25) throw new ArgumentOutOfRangeException(); _Field3 = value; } }
    ...
    public class VoteKickMessage : GameMessage
    {
        ...
        public string _Field2;
        public string Field2 { get { return _Field2; } set { if(value != null && value.Length > 1024) throw new ArgumentOutOfRangeException(); _Field2 = value; } }

        public override void Parse(GameBitBuffer buffer)
        {
            Field0 = buffer.ReadInt(4) + (-1);
            Field1 = buffer.ReadInt(4) + (-1);
            Field2 = buffer.ReadCharArray(1024);
        }
        ...
        public override void Encode(GameBitBuffer buffer)
        {
            buffer.WriteInt(4, Field0 - (-1));
            buffer.WriteInt(4, Field1 - (-1));
            buffer.WriteCharArray(1024, Field2);
        }
    ...
    public class ACDEnterKnownMessage : GameMessage
    {
        ...
        public override void Encode(GameBitBuffer buffer)
        {
            ...
            if(Field14.HasValue)
                buffer.WriteInt(32, Field14.Value);
        }
    ...
    public class SNONameDataMessage2 : GameMessage
    {
    ...
    public class MailDeleteResponseMessage : GameMessage
    {
        public long Field0;
        public int Field1;
    ...
    public class MailRetrieveResponseMessage : GameMessage
    {
        public long Field0;
        public int Field1;
    ...
    public class MailReadResponseMessage : GameMessage
    {
        public long Field0;
        public int Field1;
    ...
    public class MailDeleteMessage : GameMessage
    {
        public long Field0;
    ...
    public class BNetJoinGameRequestResultMessage : GameMessage
    {
        ...
        public int Field4;
        int _Field5;
        public int Field5 { get { return _Field5; } set { if(value < 0 || value > 0x3FFFF) throw new ArgumentOutOfRangeException(); _Field5 = value; } }
        public int Field6;
    ...
    public class CreateBNetGameMessage : GameMessage
    {
        ...
        public int Field6;
        int _Field7;
        public int Field7 { get { return _Field7; } set { if(value < 0 || value > 0x3FFFF) throw new ArgumentOutOfRangeException(); _Field7 = value; } }
        int _Field8;
    ...
    public class NewPlayerMessage : GameMessage
    {
        ...
        int _Field8;
        public int Field8 { get { return _Field8; } set { if(value < 0 || value > 100) throw new ArgumentOutOfRangeException(); _Field8 = value; } }
        public HeroStateData Field9;
        public bool Field10;
        public int Field11;
        public int Field12;
    ...
    public class GameSyncedData
    {
        ...
        int[] _Field9;
        public int[] Field9 { get { return _Field9; } set { if(value != null && value.Length != 2) throw new ArgumentOutOfRangeException(); _Field9 = value; } }
        int[] _Field10;
        public int[] Field10 { get { return _Field10; } set { if(value != null && value.Length != 2) throw new ArgumentOutOfRangeException(); _Field10 = value; } }
        ...
        public void Encode(GameBitBuffer buffer)
        {
            ...
            for(int i = 0;i < _Field10.Length;i++) buffer.WriteInt(32, _Field10[i]);
        }
